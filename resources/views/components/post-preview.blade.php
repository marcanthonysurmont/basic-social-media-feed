...
<br>
<div class="block max-w-[877px] mx-auto bg-white text-gray-800 rounded-lg overflow-hidden shadow-lg relative"> <!-- Added relative positioning -->
    <a href="#" class="block relative">
        <div class="p-6 relative"> <!-- Added relative positioning -->
            <p class="text-sm font-semibold text-gray-400 mb-2">{{$post->user->name}}</p>
            <h2 class="text-xl font-semibold mb-2">{{$post->title}}</h2>
            @if(Auth::id() === $post->user_id)
                <div class="absolute top-0 right-0 transform p-4"> <!-- Positioned edit logo -->
